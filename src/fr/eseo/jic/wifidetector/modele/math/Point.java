...
public class Point {
	...
	public static final String MSG_ABSCISSE_NEGATIVE = "L'abscisse doit �tre positive";
	public static final String MSG_ORDONNEE_NEGATIVE = "L'ordonn�e doit �tre positive";
