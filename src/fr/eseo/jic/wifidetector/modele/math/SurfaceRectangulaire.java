...
public class SurfaceRectangulaire extends Surface{
	...
	private int largeur;
	private int hauteur;
	public static final String MSG_LARGEUR_NEGATIVE = "La largeur doit �tre positive";
	public static final String MSG_HAUTEUR_NEGATIVE = "La hauteur doit �tre positive";
