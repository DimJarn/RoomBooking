...
public class FenetreCartographieWifi extends JFrame {
	...
	private FenetreCartographieWifi(){
		...
		JLabel labelInformation = new JLabel("Entrez la dimension de la salle afin de savoir où effectuer les relevés.");
		...
		/**
		 * JPanel panel = new VueSalle(); 
		System.out.println("Je réalise ");

		this.setContentPane(panel);
		System.out.println("Je réalise2 ");
		 */
