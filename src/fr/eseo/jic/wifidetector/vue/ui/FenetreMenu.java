...
public class FenetreMenu extends JFrame{
	...
	private FenetreMenu(){
		...
		labelImageFondMenu.setIcon(new ImageIcon("/Users/dimitrijarneau/workspace/ProjectWifiDetection/img/FenetreAccueil/wifi-4.png"));
		...
		labelTextBehindTittle = new JLabel("Cette application permet de cartographier la qualité du réseau wifi dans une salle.");
